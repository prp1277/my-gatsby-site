...
export default ({ children }) => 
  <div style={{ margin: `none`, maxWidth: `100%`, backgroundColor: `WhiteSmoke`}}>
  <header style={{ backgroundColor: `Green`, marginBottom: `1.5rem`,}}>
     <Link to="/" style={{ color: `Snow` }}>
     <h1 style={{ display: "inline-block", marginLeft: `2rem` }}>Fake News!</h1></Link>
     <ul style={{ listStyle: `none`, float: `right`, fontSize: `20px` }}>
